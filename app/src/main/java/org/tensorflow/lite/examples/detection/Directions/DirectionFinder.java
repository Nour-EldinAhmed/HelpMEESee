...
public class DirectionFinder {
    ...
    //public static final String DIRECTION_URII="https://maps.googleapis.com/maps/api/geocode/json?address=";

    private static final String GOOGLE_API_KEY = "AIzaSyBjZhyj8K5RiidWHZobe3-nnkHHQwIoItM";
    private DirectionFinderListener listener;
    private String origin;
    private String destination;
